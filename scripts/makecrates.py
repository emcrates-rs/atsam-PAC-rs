...
Modified by Michael Berger for autogeneration of files for ATSAM family.
"""
...
CRATE_DOC_FEATURES = {
    "atsam3x": ["rt", "atsam3x4c", "atsam3x4e", "atsam3x8c", "atsam3x8e"]
}
...
readme = "README.md"
keywords = ["atsam", "svd2rust", "no_std", "embedded"]
...
def main(devices_path, yes, families):
    ...
    for path in glob.glob(os.path.join(devices_path, "*.yaml")):
        ...
        family = re.match(r'atsam[0-9]+[a-z]', yamlfile)[0]
